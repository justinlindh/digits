...
type LineStore interface {
	...
	EffectiveLineSettingsForLine(ctx context.Context, number string, lineID int64) (*LineSettings, error)
	...
	WithRenumberReadFence(ctx context.Context, fn func(context.Context) error) error
}
