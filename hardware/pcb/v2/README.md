...
This directory is the source of truth for PCB v2. Schematic, footprint placement, and design notes all live here.
...
kicad-cli pcb drc --refill-zones \
  hardware/pcb/v2/kicad/digits-pcb.kicad_pcb -o /tmp/drc.rpt
```
