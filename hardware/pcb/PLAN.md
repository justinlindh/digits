...
Ideas to consider if revisiting the carrier board design for a second revision.
...
Add exposed pads for key signals: +5V, +12V, GND, UART TX/RX, switching node (U1 OUT), and hook switch. Zero cost, makes assembly debugging with a multimeter much easier. Should go on every revision.
